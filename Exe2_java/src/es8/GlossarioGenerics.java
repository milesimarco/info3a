...
cui il primo elemento A ̬ ordinabile. Questa classe ha un metodo insertInOrdine che inserisce una
coppia in ordine rispetto il primo elemento della coppia.
Ha un metodo find che cerca un A e se lo trova (il primo che trova) restituisce il B con cui A ̬
accoppiato. Se non c'̬ restituisce null.
